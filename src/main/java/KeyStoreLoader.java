...
class KeyStoreLoader {
    ...
    KeyStoreLoader load(File baseDir) throws Exception {
        ...
        File serverKeyStore = baseDir.toPath().resolve("server-cert.pfx").toFile();
        ...
        if (!serverKeyStore.exists()) {
            ...
            String applicationUri = "urn:fanitoring:opc:server:" + UUID.randomUUID();

            SelfSignedCertificateBuilder builder = new SelfSignedCertificateBuilder(keyPair)
                .setCommonName("Fanitoring OPC Server")
                .setOrganization("fanap Soft")
                .setOrganizationalUnit("dev")
                .setLocalityName("Tehran")
                .setStateName("Teh")
                .setCountryCode("IR")
